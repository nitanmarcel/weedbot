...
# Also yoda translator does the same thing with contractions.. I'm just
# helping him
replace_dict = {
    "Aren't": "Are not",
    "Can't": "Cannot",
...
def yodify(text):
    ...
    service_uri = 'http://www.yodaspeak.co.uk/webservice/yodatalk.php?wsdl'
    client = Client(service_uri)
    res = client.service.yodaTalk(result)
    return res
